                            ...
                            <div class="row" align="left" style="padding-right:20px;">
                                <form name="myform" action="wall" method="get">
                                    ...
                                    <div text-align="justify">
                                        <textarea align="center" cols="25" rows="3" color="#290029" name="postedText" style="background:white" placeholder="Update status..." style="font-family:monospace" style="color:#009900" style="border style:solid" ></textarea>
                                        <% 
											session.setAttribute("userWhoPosted",userFound);
										%>
                                        <br>
                                        <b><input type="submit" value="Update" align="right" style="padding-right:15px ; padding-left:15px;margin-left:140px;border-radius:500px;background-color:#009900;color:white;"></b>
                                    </div>
                                </form>
                            </div>
                        </div>  
                    ...
                    <div class="col-md-6 background" align="center" style="padding-bottom:-20px;">
                        <div class="row" align="center" style="width:95%;height:100px;text-align:justify;">
                            <form action="wall" method="get">
                                <br>
                                <b><textarea name="postedText" placeholder="Add a post..." cols="56" rows="2"></textarea></b>
                                <br>
                                <input type="hidden" name="service" value="addPost">
								<% 
									session.setAttribute("userWhoPosted",userFound);
								%>
                                <div class="row" align="right" style="padding-right:15px ; padding-top:10px;" >
                                    <b><input type="submit" value="Post" align="right" style="padding-right:15px ; background-color:#009900;padding-left:15px;border-radius:500px;color:white;"></b>
                                </div>
                            </form>    
                        </div>
                        <hr>
                        <div class="scroll" style="height: 353px; overflow-y:auto;">
                        	<%
								try{%>
									<% 	dbConnector=new DataBaseConnector();
										db=DataBaseConnector.getDatabase();
										...
										<% while(itt.hasNext()){
					                            ...
					                            <div class="transbox" align="center" style="width:95%;height:auto;text-align:justify;padding-left:2%;padding-right:2%;padding-top:2%;padding-bottom:2%;">
														...
														<br>												
														<div class="scroll" style="height: 125px; overflow-y:auto;">
															<div>
															<%
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="row" style="padding-left:10px">
                            <form action="wall" method="get">
								...
								<input type="hidden" name="username" value="<%= userFound.get("_id")%>">
								<div class="col-md-2">
                                    <input type="text" name="friendName" placeholder="Enter friendID...">
                                </div>
                                <div class="col-md-1">
